...
class AboutController extends Controller
{
    public function about()
    {
        $arrayName = [
            ...
            ['nama' => "Muhammad Naufal Abbad Mu' afa Rizqullah", 'nim' => '24104410049', 'peran' => 'implements a /home route handled by logic in the HomeController, where key data such as the website name, tagline, and team name are prepared and passed to the view. ', 'foto' => '5.png']
        ];
