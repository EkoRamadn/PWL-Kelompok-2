...
@section('content')
    <div class=" md:p-6 ">
        <div class="flex justify-between flex-col rounded-xl shadow  bg-white mb-7 ">
            ...
            <div
                class="right flex  gap-2 md:gap-0 justify-center px-4 py-1  text-red-500  rounded-3xl   w-max self-center my-10 ">
                <p class="text-base md:text-xl f font-medium uppercase">{{ $homeData->namaKelompok }} </p>
                <p class=" text-base md:text-xl font-medium text-black  md:text-right ml-1 "> • {{ $homeData->semester }}
                </p>
            </div>
        </div>
        ...
        <div class="mt-2 flex flex-col md:flex-row gap-4">
            ...
            <div class="w-full md:w-[300px] relative">
                <div
                    class="flex w-full h-[300px] overflow-x-auto snap-x snap-mandatory scroll-smooth hide-scrollbar rounded-xl">
                    ...
                    <div class="max-h-[198px] overflow-y-auto pr-2">
                        <ul class="space-y-3 text-sm">
                            ...
                            <li class="flex justify-between border-b pb-2">
                                ...
                                <a href="https://github.com/arga-nata" target="_blank"
                                    class="text-red-500 hover:underline">arga-nata</a>
                            </li>
                            <li class="flex justify-between border-b pb-2">
                                <a href="#slide1"><span>Eko Ramadani</span></a>
                                <a href="https://github.com/EkoRamadn" target="_blank"
                                    class="text-red-500 hover:underline">EkoRamadn</a>
                            </li>

                            <li class="flex justify-between border-b pb-2">
                                <a href="#slide3"><span>Ahmad Yusron Fadil</span></a>
                                <a href="https://github.com/AhmadYusronF" target="_blank"
                                    class="text-red-500 hover:underline">AhmadYusronF</a>
                            </li>


                            <li class="flex justify-between border-b pb-2">
                                <a href="#slide4"><span>Firlian Firmansyah</span></a>
                                <a href="https://github.com/FirmanSyah2078" target="_blank"
                                    class="text-red-500 hover:underline">FirmanSyah2078</a>
                            </li>

                            <li class="flex justify-between">
                                <a href="#slide5"><span>Naufal Abad</span></a>
                                <a href="https://github.com/4estra" target="_blank"
                                    class="text-red-500 hover:underline">4estra</a>
                            </li>
