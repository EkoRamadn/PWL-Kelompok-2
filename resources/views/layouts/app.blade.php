...
<header class="bg-blue-800 text-white shadow-md fixed top-0 left-0 right-0 md:relative">
  <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <nav class="transition-all  duration-300 hidden peer-checked:flex flex-col absolute top-16 left-0 w-full bg-blue-800 md:static md:flex md:flex-row md:w-auto md:space-x-4 md:bg-transparent z-50">
